...
def romanian_numbers(num):
    "Return a string with the romanian number from 1 to 3000"
    UNIDADES = { 0: '', 1: 'I', 2: 'II', 3: 'III', 4: 'IV', 5: 'V', 6: 'VI',
                 7: 'VII', 8: 'VIII', 9: 'IX' }
    DEZENAS = { 0: '', 1: 'X', 2: 'XX', 3: 'XXX', 4: 'XL', 5: 'L', 6: 'LX',
                7: 'LXX', 8: 'LXXX', 9: 'XC' }
    CENTENAS = { 0: '', 1: 'C', 2: 'CC', 3: 'CCC', 4: 'CD', 5: 'D', 6: 'DC',
                 7: 'DCC', 8:'DCCC', 9:'CM' }
    MILHARES = { 0: '', 1: 'M', 2: 'MM', 3: 'MMM'} 
    ...
    lista = []
    i = -1
    for base in (UNIDADES, DEZENAS, CENTENAS, MILHARES):
...
if __name__ == '__main__':
    ...
    print(romanian_numbers(2015))
    print(romanian_numbers(3000))
